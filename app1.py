...
.stCheckbox label {
    ...
    gap: 10px !important;
    cursor: pointer;
    min-height: 40px !important; /* スマホでのタップしやすさ維持 */
}
.stCheckbox label span {
    font-size: 16px !important;
}
/* チェックボックス本体（少し上品なサイズに） */
...
[data-testid="stExpander"] [data-testid="column"]:nth-child(2) .stButton button {
    ...
    opacity: 0.6; /* 薄くして悪目立ちを防ぐ */
    transition: opacity 0.2s, background 0.2s;
}
/* ゴミ箱タップ時のハイライト */
[data-testid="stExpander"] [data-testid="column"]:nth-child(2) .stButton button:active {
    opacity: 1.0;
    background: rgba(255, 100, 100, 0.2) !important;
    border-radius: 50% !important;
}

/* 🔴 スマホ特有のカラム縦積みを完全ブロック＆レイアウト微調整 */
@media (max-width: 768px) {
    [data-testid="stExpander"] [data-testid="stHorizontalBlock"] {
        ...
        width: 100% !important;
        gap: 0px !important;
        padding: 4px 8px 4px 0px !important; /* ★右側に少し余白を作り、壁ドンを直す */
    }
    /* カラムの余白を強制リセット */
    ...
    /* 項目名の列（チェックボックス側） */
    [data-testid="stExpander"] [data-testid="stHorizontalBlock"] > [data-testid="column"]:nth-child(1) {
        flex: 1 1 0% !important;
        width: auto !important;
        min-width: 0 !important;
    }
    /* ゴミ箱の列（幅を40pxに固定） */
    [data-testid="stExpander"] [data-testid="stHorizontalBlock"] > [data-testid="column"]:nth-child(2) {
        flex: 0 0 40px !important;
        width: 40px !important;
        min-width: 40px !important;
        display: flex !important;
        justify-content: flex-end !important; /* 中身を右に寄せる */
    }
}
